...
public class LoggerBundle_it extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    ...
    {"REQURIED_ELEMENT_SKINVERSION_NOT_FOUND", "Elemento figlio richiesto per \'versione\', \'nome\' non trovato."},
    ...
    {"INVALID_ACC_PROFILE", "Il valore \'\'{0}\'\' non \u00e8 una propriet\u00e0 di accessibilit\u00e0-profilo valida"},
    ...
    {"INVALID_LOCALE_LANG_LENGTH", "Lingua non valida per l\'\'ID impostazioni nazionali {0}. Il codice lingua deve essere di due caratteri. Vedere il documento Java delle impostazioni nazionali per il formato corretto. Verranno utilizzate le impostazioni nazionali della pagina corrente."},
    {"INVALID_LOCALE_LANG_CASE", "Lingua non valida per l\'\'ID impostazioni nazionali {0}. Il codice lingua deve essere in lettere minuscole. Vedere il documento Java delle impostazioni nazionali per il formato corretto. Verranno utilizzate le impostazioni nazionali della pagina corrente."},
    {"INVALID_LOCALE_COUNTRY_LENGTH", "Paese non valido per l\'\'ID impostazioni nazionali {0}. Il codice paese deve essere di due caratteri. Vedere il documento Java delle impostazioni nazionali per il formato corretto. Verr\u00e0 utilizzata una stringa vuota per il paese."},
    {"INVALID_LOCALE_COUNTRY_CASE", "Paese non valido per l\'\'ID impostazioni nazionali {0}. Il codice paese deve essere in lettere maiuscole. Vedere il documento Java delle impostazioni nazionali per il formato corretto. Verr\u00e0 utilizzata una stringa vuota per il paese."},
    {"INVALID_LOCALE_VARIANT_HAS_SLASH", "Variante non valida per l\'\'ID impostazioni nazionali {0}. Non pu\u00f2 contenere barre per evitare attacchi XSS. Verr\u00e0 utilizzata una stringa vuota per la variante."},
    {"COULD_NOT_DELETE_FILE", "Impossibile eliminare il file {0}"},
    {"UNEXPECTED_STATE", "IState deve essere un\'istanza di StateManager.SerializedView o un array dell\'oggetto di lunghezza 2."},
    {"PARTIAL_STATE_SAVING_NOT_SUPPORTED", "Il salvataggio parziale dello stato non \u00e8 ancora supportato. Impostare context-param javax.faces.PARTIAL_STATE_SAVING su false nel file web.xml."},
    {"ATTRIBUTE_SERIALIZATION_FAILED", "Errore durante la serializzazione dell\'\'attributo {0}:{1} valore:{2}"},
    {"ATTRIBUTE_NOT_SERIALIABLE", "Errore di failover: {0} l\'\'attributo {1} di tipo {2} non \u00e8 serializzabile"},
    {"SERIALIZABLE_ATTRIBUTE_MUTATED", "Errore di failover: serializzazione dell\'\'attributo {0}: {1} \u00e8 cambiata da {2} a {3} senza modificare l\'\'attributo"},
    };
  }
}
