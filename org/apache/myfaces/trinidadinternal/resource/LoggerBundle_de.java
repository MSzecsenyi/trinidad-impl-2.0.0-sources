...
public class LoggerBundle_de extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    ...
    {"UNABLE_FLIP_ICON", "Symbol \'\'{0}\'\' kann nicht gekippt werden, weil es sich nicht unter dem aktuellen Anforderungskontext \'\'{1}\'\' befindet"},
    ...
    {"REQURIED_ELEMENT_SKINVERSION_NOT_FOUND", "Erforderliches untergeordnetes Element f\u00fcr \\\'\'version\\\'\', \\\'\'name\\\'\' nicht gefunden."},
    ...
    {"INVALID_ACC_PROFILE", "Der Wert \"{0}\" ist keine g\u00fcltige Eigenschaft des Eingabehilfen-Profils."},
    ...
    {"PER_REQUEST_DISK_SPACE_LIMITS_EXCEEDED", "Grenzwerte f\u00fcr Datentr\u00e4gerspeicherplatz pro Anforderung \u00fcberschritten."},
    ...
    {"NULL_REQUEST_ON_THIS_CONTEXT", "Anforderung ist f\u00fcr diesen Kontext Null."},
    {"NULL_RESPONSE_ON_THIS_CONTEXT", "Antwort ist f\u00fcr diesen Kontext Null."},
    ...
    {"NULL_LOCALE_CONTEXT", "Kein Gebietsschemakontext"},
    ...
    {"INVALID_LOCALE_LANG_LENGTH", "Ung\u00fcltige Sprache f\u00fcr Gebietsschemabezeichner {0} - Sprachcode muss 2 Zeichen umfassen. In der Javadoc f\u00fcr das Gebietsschema wird das richtige Format angegeben. Das aktuelle Seitengebietsschema wird verwendet."},
    {"INVALID_LOCALE_LANG_CASE", "Ung\u00fcltige Sprache f\u00fcr Gebietsschemabezeichner {0} - Sprachcode muss aus Kleinbuchstaben bestehen. In der Javadoc f\u00fcr das Gebietsschema wird das richtige Format angegeben. Das aktuelle Seitengebietsschema wird verwendet."},
    {"INVALID_LOCALE_COUNTRY_LENGTH", "Ung\u00fcltiges Land f\u00fcr Gebietsschemabezeichner {0} - Landescode muss 2 Zeichen umfassen. In der Javadoc f\u00fcr das Gebietsschema wird das richtige Format angegeben. Leere Zeichenfolge wird f\u00fcr Land verwendet."},
    {"INVALID_LOCALE_COUNTRY_CASE", "Ung\u00fcltiges Land f\u00fcr Gebietsschemabezeichner {0} - Landescode muss in Gro\u00dfbuchstaben angegeben werden. In der Javadoc f\u00fcr das Gebietsschema wird das richtige Format angegeben. Leere Zeichenfolge wird f\u00fcr Land verwendet."},
    {"INVALID_LOCALE_VARIANT_HAS_SLASH", "Ung\u00fcltige Variante f\u00fcr den Gebietsschemabezeichner {0} - Sie darf keine  Schr\u00e4gstriche enthalten, um XSS-Angriffe zu vermeiden. Leere Zeichenfolge wird f\u00fcr Variante verwendet."},
    {"COULD_NOT_DELETE_FILE", "Die Datei {0} konnte nicht gel\u00f6scht werden"},
    {"UNEXPECTED_STATE", "IState muss eine Instanz von StateManager.SerializedView oder ein Objekt-Array mit der L\u00e4nge 2 sein."},
    {"PARTIAL_STATE_SAVING_NOT_SUPPORTED", "Teilstatusspeicherung wird noch nicht unterst\u00fctzt. Setzen Sie context-param javax.faces.PARTIAL_STATE_SAVING in web.xml auf \"false\"."},
    {"ATTRIBUTE_SERIALIZATION_FAILED", "Fehler beim Serialisieren von {0}-Attribut:{1} Wert:{2}"},
    {"ATTRIBUTE_NOT_SERIALIABLE", "Failover-Fehler: {0} Attribut:{1} vom Typ {2} ist nicht serialisierbar"},
    {"SERIALIZABLE_ATTRIBUTE_MUTATED", "Failover-Fehler: Serialisierung von {0}-Attribut:{1} wurde von {2} in {3} ge\u00e4ndert, ohne dass das Attribut zum ersten Mal ver\u00e4ndert wurde"},
    };
  }
}
