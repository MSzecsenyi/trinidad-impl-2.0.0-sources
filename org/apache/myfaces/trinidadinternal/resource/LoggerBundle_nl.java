...
public class LoggerBundle_nl extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    ...
    {"REQURIED_ELEMENT_SKINVERSION_NOT_FOUND", "Vereist onderliggend element voor \'version\', \'name\' is niet gevonden."},
    ...
    {"INVALID_ACC_PROFILE", "De waarde {0} is geen geldige toegankelijkheidsprofieleigenschap."},
    ...
    {"DATETIMERANGEVALIDATOR_REQUIRES_EDITABLEVALUEHOLDER", "Voor de DateTimeRangeValidator moet de component een EditableValueHolder zijn om clientvalidatie te laten werken. Clientvalidatie wordt gedeactiveerd voor component {0}."},
    {"INVALID_LOCALE_LANG_LENGTH", "Ongeldige taal voor locale-ID {0}. De taalcode moet uit 2 tekens bestaan. Zie javadoc over locale voor de juiste notatie. De huidige paginalocale wordt gebruikt."},
    {"INVALID_LOCALE_LANG_CASE", "Ongeldige taal voor locale-ID {0}. De taalcode moet in kleine letters zijn. Zie javadoc over locale voor de juiste notatie. De huidige paginalocale wordt gebruikt."},
    {"INVALID_LOCALE_COUNTRY_LENGTH", "Ongeldig land voor locale-ID {0}. De landcode moet uit 2 tekens bestaan. Zie javadoc over locale voor de juiste notatie. Er wordt een lege string gebruikt voor het land."},
    {"INVALID_LOCALE_COUNTRY_CASE", "Ongeldig land voor locale-ID {0}. De landcode moet in hoofdletters zijn. Zie javadoc over locale voor de juiste notatie. Er wordt een lege string gebruikt voor het land."},
    {"INVALID_LOCALE_VARIANT_HAS_SLASH", "Ongeldige variant voor locale-ID {0}. De variant mag geen slashes bevatten. Dit om XSS-aanvallen te voorkomen. Er wordt een lege string gebruikt voor de variant."},
    {"COULD_NOT_DELETE_FILE", "Het volgende bestand kan niet worden verwijderd: {0}."},
    {"UNEXPECTED_STATE", "IState moet een instance zijn van StateManager.SerializedView of een objectarray met lengte 2."},
    {"PARTIAL_STATE_SAVING_NOT_SUPPORTED", "Gedeeltelijk opslaan van status wordt nog niet ondersteund. Stel context-param javax.faces.PARTIAL_STATE_SAVING in op \'niet waar\' in web.xml."},
    {"ATTRIBUTE_SERIALIZATION_FAILED", "Fout bij serialiseren van {0} attribuut: {1} waarde: {2}."},
    {"ATTRIBUTE_NOT_SERIALIABLE", "Failover-fout: {0} attribuut: {1} van het type {2} is niet serialiseerbaar."},
    {"SERIALIZABLE_ATTRIBUTE_MUTATED", "Failover-fout: serialisatie van {0} attribuut: {1} is gewijzigd van {2} in {3} zonder dat het attribuut is vervuild."},
    };
  }
}
