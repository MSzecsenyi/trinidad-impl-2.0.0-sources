...
public class LoggerBundle extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    ...
    {"REQURIED_ELEMENT_SKINVERSION_NOT_FOUND", "Required child element for \'version\', \'name\' not found."},
    ...
    {"COULD_NOT_DELETE_FILE", "Could not delete the file {0}"},
    {"UNEXPECTED_STATE", "IState must be an instance of StateManager.SerializedView or an Object array of length 2."},
    {"PARTIAL_STATE_SAVING_NOT_SUPPORTED", "Partial state saving is not yet supported. Please set context-param javax.faces.PARTIAL_STATE_SAVING to false in your web.xml."},
    {"ATTRIBUTE_SERIALIZATION_FAILED_KEY_VALUE", "Error serializing {0} attribute:{1}"},
    {"EXTRACT_SERIALIZATION_DETAIL", "failed value="},
    {"ATTRIBUTE_NOT_SERIALIABLE", "Failover error: {0} attribute:{1} of type {2} is not Serializable"},
    {"SERIALIZABLE_ATTRIBUTE_MUTATED", "Failover error: Serialization of {0} attribute:{1} has changed from {2} to {3} without the attribute being dirtied"},
    {"SERIALIZATION_TESTING_FAILURE", "Session attribute serialization testing failed for {0}. This check can be disabled by removing \'REQUEST\' from the \'org.apache.myfaces.trinidad.CHECK_STATE_SERIALIZATION\' system property"},
    {"SERIALIZATION_LOGGING_FAILURE", "Exception gathering session attribute serialization testing failure"},
    {"SESSION_SERIALIZATION_ATTRIBUTE", "Session attribute:{0}"},
    };
  }
}
