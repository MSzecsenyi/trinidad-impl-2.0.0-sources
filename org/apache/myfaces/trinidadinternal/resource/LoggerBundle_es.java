...
public class LoggerBundle_es extends ListResourceBundle {
  ...
  public Object[][] getContents() {
    ...
    {"REQURIED_ELEMENT_SKINVERSION_NOT_FOUND", "No se ha encontrado el elemento secundario para \'version\', \'name\' necesario."},
    ...
    {"INVALID_ACC_PROFILE", "El valor \'\'{0}\'\' no es una propiedad de perfil de accesibilidad v\u00e1lida"},
    ...
    {"INVALID_LOCALE_LANG_LENGTH", "Idioma no v\u00e1lido para el identificador de configuraci\u00f3n regional {0}: El c\u00f3digo de idioma debe tener 2 caracteres, consulte la documentaci\u00f3n Java sobre configuraci\u00f3n regional para conocer el formato correcto. Se utilizar\u00e1 la configuraci\u00f3n regional de la p\u00e1gina actual."},
    {"INVALID_LOCALE_LANG_CASE", "Idioma no v\u00e1lido para el identificador de configuraci\u00f3n regional {0}: El c\u00f3digo de idioma debe estar en min\u00fascula, consulte la documentaci\u00f3n Java sobre configuraci\u00f3n regional para conocer el formato correcto. Se utilizar\u00e1 la configuraci\u00f3n regional de la p\u00e1gina actual."},
    {"INVALID_LOCALE_COUNTRY_LENGTH", "Pa\u00eds no v\u00e1lido para el identificador de configuraci\u00f3n regional {0}: El c\u00f3digo de pa\u00eds debe tener 2 caracteres, consulte la documentaci\u00f3n Java sobre configuraci\u00f3n regional para conocer el formato correcto. Se utilizar\u00e1 una cadena vac\u00eda para el pa\u00eds"},
    {"INVALID_LOCALE_COUNTRY_CASE", "Pa\u00eds no v\u00e1lido para el identificador de configuraci\u00f3n regional {0}: El c\u00f3digo de pa\u00eds debe estar en may\u00fascula, consulte la documentaci\u00f3n Java sobre configuraci\u00f3n regional para conocer el formato correcto. Se utilizar\u00e1 una cadena vac\u00eda para el pa\u00eds"},
    {"INVALID_LOCALE_VARIANT_HAS_SLASH", "Variante no v\u00e1lida para el identificador de configuraci\u00f3n regional {0}: No puede contener barras para evitar el ataque de XSS. Se utilizar\u00e1 una cadena vac\u00eda para la variante."},
    {"COULD_NOT_DELETE_FILE", "No se ha podido suprimir el archivo {0}"},
    {"UNEXPECTED_STATE", "IState debe ser una instancia de StateManager.SerializedView o una matriz de objeto de longitud 2."},
    {"PARTIAL_STATE_SAVING_NOT_SUPPORTED", "El almacenamiento de estado parcial a\u00fan no est\u00e1 soportado. Defina context-param javax.faces.PARTIAL_STATE_SAVING como falso en web.xml."},
    {"ATTRIBUTE_SERIALIZATION_FAILED", "Error al serializar {0} atributo:{1} valor:{2}"},
    {"ATTRIBUTE_NOT_SERIALIABLE", "Error de failover: {0} atributo: {1} de tipo {2} no serializable"},
    {"SERIALIZABLE_ATTRIBUTE_MUTATED", "Error de failover: La serializaci\u00f3n de {0} atributo: {1} ha cambiado de {2} a {3} sin que se haya ensuciado el atributo."},
    };
  }
}
