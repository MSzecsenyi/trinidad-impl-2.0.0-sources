 ...
 */
public class ValidateLongRangeTag extends TrinidadValidatorELTag
{
    ...
    LongRangeValidator validator) throws JspException
  {
    if (_maximum != null)
    {
      ...
      {
        long value = TagUtils.getLong(_maximum.getValue(null));
    ...
    if (_minimum != null)
    {
      ...
      {
        long value = TagUtils.getLong(_minimum.getValue(null));
