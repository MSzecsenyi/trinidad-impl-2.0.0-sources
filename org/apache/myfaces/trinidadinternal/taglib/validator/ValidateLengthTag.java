...
public class ValidateLengthTag extends TrinidadValidatorELTag
{
  ...
  public void setMessageDetailExact(ValueExpression messageDetailExact)
  {
    ...
    LengthValidator validator) throws JspException
  {
    ...
    if (_minimum != null)
    {
      ...
      {
        int value = TagUtils.getInteger(_minimum.getValue(null));
    ...
    {
      if (!_messageDetailExact.isLiteralText())
      {
        validator.setValueExpression("messageDetailExact", _messageDetailExact);
      }
      else
      {
        String value = TagUtils.getString(_messageDetailExact.getValue(null));
