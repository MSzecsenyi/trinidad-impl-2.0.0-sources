 ...
 */
public class ValidateDateTimeRangeTag extends TrinidadValidatorELTag
{
    ...
    DateTimeRangeValidator validator) throws JspException
  {
    if (_maximum != null)
    {
      ...
      {
        Date value = TagUtils.getDateWithMaxTime(_maximum.getValue(null));
    ...
    if (_minimum != null)
    {
      ...
      {
        Date value = TagUtils.getDate(_minimum.getValue(null));
