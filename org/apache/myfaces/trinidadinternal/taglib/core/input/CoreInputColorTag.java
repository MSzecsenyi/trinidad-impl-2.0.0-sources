...
public class CoreInputColorTag extends UIXSelectInputTag
{
  ...
  private ValueExpression _compact;
  final public void setCompact(ValueExpression compact)
  {
    _compact = compact;
  }
    ...
    FacesBean bean)
  {
    ...
    setProperty(bean, CoreInputColor.DISABLED_KEY, _disabled);
    ...
    setProperty(bean, CoreInputColor.ACCESS_KEY_KEY, _accessKey);
    setProperty(bean, CoreInputColor.SHOW_REQUIRED_KEY, _showRequired);
    setProperty(bean, CoreInputColor.ONKEYUP_KEY, _onkeyup);
    setProperty(bean, CoreInputColor.COMPACT_KEY, _compact);
    ...
    setProperty(bean, CoreInputColor.READ_ONLY_KEY, _readOnly);
    setProperty(bean, CoreInputColor.COLUMNS_KEY, _columns);
