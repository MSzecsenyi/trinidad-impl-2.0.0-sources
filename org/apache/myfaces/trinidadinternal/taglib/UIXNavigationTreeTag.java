...
abstract public class UIXNavigationTreeTag extends UIXCollectionTag
{
  ...
  final public void setStartLevel(ValueExpression startLevel)
  {
    ...
    FacesBean bean)
  {
    ...
    bean.setProperty(UIXNavigationTree.ROW_DISCLOSURE_LISTENER_KEY, _rowDisclosureListener);
    setProperty(bean, UIXNavigationTree.IMMEDIATE_KEY, _immediate);
    setProperty(bean, UIXNavigationTree.START_LEVEL_KEY, _startLevel);
